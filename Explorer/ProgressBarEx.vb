...
Public Class ProgressBarEx
    ...
    <Browsable(True)> <DefaultValue(GetType(Color), "DarkGray")>
    ...
    <Browsable(True)> <DefaultValue(GetType(Color), "Lime")>
    ...
    <Browsable(True)> <DefaultValue(GetType(Color), "White")>
    ...
    <Browsable(True)> <DefaultValue(GetType(Color), "Black")>
    ...
    <Browsable(True)> <DefaultValue(GetType(GradiantArea), "Top")>
    Public Property GradiantPosition() As GradiantArea
        ...
        Set(ByVal value As GradiantArea)
            ...
            If value = GradiantArea.None Then
                bBlend.Factors = New Single() {0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F}
            ElseIf value = GradiantArea.Top Then
                bBlend.Factors = New Single() {0.8F, 0.7F, 0.6F, 0.4F, 0.0F, 0.0F}
            ElseIf value = GradiantArea.Center Then
                bBlend.Factors = New Single() {0.0F, 0.4F, 0.6F, 0.6F, 0.4F, 0.0F}
            Else
                bBlend.Factors = New Single() {0.0F, 0.0F, 0.4F, 0.6F, 0.7F, 0.8F}
            End If
            Me.Refresh()
        End Set
    End Property
    ...
    <Browsable(True)> <DefaultValue(GetType(ImageLayoutType), "None")>
    ...
    <Browsable(True)> <DefaultValue(GetType(ProgressDir), "Horizontal")>
